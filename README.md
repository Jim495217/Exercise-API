...
The Exercise Program API is a RESTful backend service designed to manage workout exercises.
It supports **user authentication using JWT**, and **CRUD operations** for exercises with proper access control.
...
This Postman documentation provides complete examples for testing and grading purposes.
